		...
		<div id="search_wrap">
			<div id="search_car">
				<div class="search_title">
					<h4>전기친환경차</h4>
					<span class="refresh" id="refresh">선택 초기화</span><img id="re_img" src="<%=request.getContextPath()%>/img/refresh.png" width="15px" height="15px">
				</div>
				<div class="search_group">
					<fieldset>
						...
						<div class="search_category">
							<h5 class="slideopen">
								<a id="category">차종
								<span class="arrow" id="arrow"><img id="arr_img" src="<%=request.getContextPath()%>/img/arrow2.png" width="15px" height="10px"></span>
								</a>
							</h5>
